...
docker buildx build  --push --platform linux/amd64 --no-cache ./dev_container --target final -t jayar79/chordpro:dev_container

# docker build --no-cache -t chordpro:dev ./dev
# docker tag chordpro:dev jayar79/chordpro:dev
# docker push jayar79/chordpro:dev

docker buildx build  --push --platform linux/amd64 --no-cache ./dev --target final -t jayar79/chordpro:dev